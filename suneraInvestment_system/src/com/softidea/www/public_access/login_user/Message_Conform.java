...
public class Message_Conform extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Message_Conform
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Message_Conform.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Message_Conform().setVisible(true);
            }
        });
    }
