        ...
        if (!(fundAmount.isEmpty() && fundDiscription.isEmpty())) {
            try {
                try {
                    ...
                    String sql_qury = "INSERT INTO fund (fund,fund_update,fund_date,fund_enddate,descriptin,fund_status,funder_idfunder) VALUES('" + Double.parseDouble(fundAmount_text) + "','" + Double.parseDouble(fundAmount_text) + "','" + date + "','" + backDate + "','" + ta_FundDiscription.getText().trim() + "','Active','" + idfunder + "')";
                    MC_DB.update_data(sql_qury);

                    String sql_tocash = "INSERT INTO `cash_account` (`date`,`amount`,`cash_ac_type`,`cash_ac_discription`,`cash_ac_status`) VALUES ('" + date + "','" + Double.parseDouble(fundAmount_text) + "','Fund','" + ta_FundDiscription.getText().trim() + "','Active');";
